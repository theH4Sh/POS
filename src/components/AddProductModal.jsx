          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black text-white tracking-tight leading-none">
                Add New <span className="opacity-60 font-light italic">Product</span>
              </h2>
              <p className="text-blue-100/60 text-[10px] font-bold uppercase tracking-widest mt-1.5 ml-0.5">Inventory Catalog Entry</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div>
                <label className="text-[11px] font-black text-gray-500 uppercase tracking-widest mb-2 block ml-1">Initial Stock <span className="text-rose-500 ml-1">*</span></label>
                <input
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    className={`${inputClass} pl-14 !bg-emerald-50/30 !border-emerald-100 focus:!border-emerald-500 font-mono h-12 text-right pr-4 text-emerald-700 font-black`}
                    placeholder="0.00"
                    type="number"
                    step="0.01"
          ...
          <div className="space-y-5">
            ...
            <div>
              <textarea
                ...
                placeholder="Add important details about usage, storage or active ingredients..."
          ...
          <div className="flex gap-4 pt-4 border-t border-gray-100">
            ...
            >
              <Plus className="h-4 w-4" /> Finalize Addition
            </button>
          </div>
        </form>
      </div>
