  ...
  return (
    <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-100 overflow-y-auto animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full my-8 max-h-[85vh] overflow-y-auto animate-in zoom-in-95 duration-300">
        <div className="sticky top-0 bg-gradient-to-r from-blue-700 to-indigo-900 p-6 flex items-center justify-between z-10">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    className={`${inputClass} pl-8 !bg-indigo-50/30 !border-indigo-100 focus:!border-indigo-500 font-mono text-indigo-700 font-bold`}
                    placeholder="0"
                    type="number"
                    step="1"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Enter detailed description, usage, etc..."
                rows="3"
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button
              type="submit"
              className="flex-[2] h-12 rounded-xl bg-blue-600 text-white font-black hover:bg-blue-700 shadow-lg shadow-blue-500/20 active:scale-95 transition-all duration-200 flex items-center justify-center gap-2"
            >
              <Plus className="h-5 w-5" /> Add Product to Catalog
            </button>
          </div>
        </form>
      </div>
